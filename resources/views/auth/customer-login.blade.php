...
<div class="tab-pane active container" id="settings">
                                                ...
                                                @csrf
                                                    <h5 class="mb-3 text-center text-uppercase bg-light p-2"><i class="mdi mdi-account-circle me-1"></i>Login as customer</h5>
...
@endif
                                            ...
                                            <a href="{{route('executor-register') }}"><button class="btn btn-link">login as register</button></a>
